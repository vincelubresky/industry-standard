...
const MENU_ROTATION = [
  ...
  //          Patty rotation — Week 1: 2 beef + 1 chicken · Week 2: 1 beef + 2 chicken
  {
    ...
    days: [
      { day: "Monday",
        ...
        lunch:     { main: "Bologna, 2 Slices Bread",            protein: "Bologna",        ingredients: ["Bologna","Bread","Pasta","Corn","Cake Mix"],                                                      sides: ["Pasta Salad","Corn","Cake"],                  cost: "$0.44", cal: 790 },
      ...
      { day: "Thursday",
        ...
        lunch:     { main: "PB&J, 2 Slices Bread",              protein: "Peanut Butter",  ingredients: ["Peanut Butter","Jelly","Bread","Pinto Beans","Mixed Vegetables","Cake Mix"],                    sides: ["Pinto Beans","Mixed Veg","Cake"],             cost: "$0.44", cal: 810 },
      ...
      { day: "Sunday",
        breakfast: { main: "Eggs Scrambled + Sausage",           protein: "Eggs & Sausage", ingredients: ["Eggs","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                    sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.55", cal: 710 },
        lunch:     { main: "Salami, 2 Slices Bread",             protein: "Salami",         ingredients: ["Salami","Bread","Pasta","Mixed Vegetables","Cake Mix"],                                       sides: ["Pasta Salad","Mixed Veg","Cake"],             cost: "$0.46", cal: 840 },
  ...
  },
  {
    ...
    days: [
      { day: "Monday",
        breakfast: { main: "Grits + Sausage Patty",              protein: "Sausage",        ingredients: ["Grits","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                    sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.52", cal: 640 },
        lunch:     { main: "PB&J, 2 Slices Bread",              protein: "Peanut Butter",  ingredients: ["Peanut Butter","Jelly","Bread","Pinto Beans","Peas & Carrots","Cake Mix"],                      sides: ["Pinto Beans","Peas & Carrots","Cake"],       cost: "$0.44", cal: 830 },
      ...
      { day: "Thursday",
        breakfast: { main: "Grits + 2 Boiled Eggs",              protein: "Eggs",           ingredients: ["Grits","Eggs","Bread","Jelly Packets","Drink Mix"],                                            sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.45", cal: 600 },
        lunch:     { main: "Salami, 2 Slices Bread",             protein: "Salami",         ingredients: ["Salami","Bread","Northern Beans","Carrots","Cake Mix"],                                       sides: ["Northern Beans","Carrots","Cake"],            cost: "$0.46", cal: 800 },
      ...
      { day: "Friday",
        breakfast: { main: "Grits + Sausage Patty",              protein: "Sausage",        ingredients: ["Grits","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.52", cal: 640 },
        lunch:     { main: "Salami, 2 Slices Bread",             protein: "Salami",         ingredients: ["Salami","Bread","Pinto Beans","Mixed Vegetables","Cake Mix"],                                sides: ["Pinto Beans","Mixed Veg","Cake"],             cost: "$0.48", cal: 820 },
