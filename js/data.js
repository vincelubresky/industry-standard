...
const MENU_ROTATION = [
  ...
  //          Patty rotation — Week 1: 2 beef + 1 chicken · Week 2: 1 beef + 2 chicken
  {
    ...
    days: [
      { day: "Monday",
        ...
        lunch:     { main: "Bologna on Bread",            protein: "Bologna",        ingredients: ["Bologna","Bread","Pasta","Corn","Cake Mix"],                                                      sides: ["Pasta Salad","Corn","Cake"],                  cost: "$0.44", cal: 790 },
      ...
      { day: "Tuesday",
        ...
        lunch:     { main: "PB&J",              protein: "Peanut Butter",  ingredients: ["Peanut Butter","Jelly","Bread","Instant Mashed Potatoes","Green Beans","Cake Mix"],             sides: ["Mashed Potatoes","Green Beans","Cake"],       cost: "$0.42", cal: 790 },
      ...
      { day: "Wednesday",
        ...
        lunch:     { main: "Salami on Bread",             protein: "Salami",         ingredients: ["Salami","Bread","Northern Beans","Peas & Carrots","Cake Mix"],                                sides: ["Northern Beans","Peas & Carrots","Cake"],     cost: "$0.48", cal: 820 },
      ...
      { day: "Thursday",
        ...
        lunch:     { main: "PB&J",              protein: "Peanut Butter",  ingredients: ["Peanut Butter","Jelly","Bread","Pinto Beans","Mixed Vegetables","Cake Mix"],                    sides: ["Pinto Beans","Mixed Veg","Cake"],             cost: "$0.44", cal: 810 },
      ...
      { day: "Friday",
        breakfast: { main: "Grits + Sausage Patty",              protein: "Sausage",        ingredients: ["Grits","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                    sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.52", cal: 640 },
        lunch:     { main: "Bologna on Bread",            protein: "Bologna",        ingredients: ["Bologna","Bread","Instant Mashed Potatoes","Carrots","Cake Mix"],                              sides: ["Mashed Potatoes","Carrots","Cake"],           cost: "$0.46", cal: 810 },
      ...
      { day: "Saturday",
        breakfast: { main: "Oatmeal + 2 Boiled Eggs",            protein: "Eggs",           ingredients: ["Oatmeal","Eggs","Bread","Jelly Packets","Drink Mix"],                                             sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.48", cal: 620 },
        lunch:     { main: "Turkey on Bread",             protein: "Turkey",         ingredients: ["Turkey","Bread","Northern Beans","Corn","Cake Mix"],                                          sides: ["Northern Beans","Corn","Cake"],               cost: "$0.58", cal: 870 },
        dinner:    { main: "Beef Patty & Brown Gravy",           protein: "Beef",           ingredients: ["Beef Patties","Brown Gravy Mix","Cornbread Mix","Rotini Pasta","Cake Mix"],                    sides: ["Cornbread","Pasta Salad","Cake"],             cost: "$0.66", cal: 1020 } },
      { day: "Sunday",
        breakfast: { main: "Eggs Scrambled + Sausage",           protein: "Eggs & Sausage", ingredients: ["Eggs","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                    sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.55", cal: 710 },
        lunch:     { main: "Salami on Bread",             protein: "Salami",         ingredients: ["Salami","Bread","Pasta","Mixed Vegetables","Cake Mix"],                                       sides: ["Pasta Salad","Mixed Veg","Cake"],             cost: "$0.46", cal: 840 },
  ...
  {
    week: 2, label: "Week 2",
    // Dinner patties → Tue: Chicken Patty · Wed: Beef · Sat: Chicken Patty · Sun: Beef Patty
    // Weekend = always patty + pasta salad (easy staff, minimal waste — pasta salad saves to next day)
    days: [
      { day: "Monday",
        breakfast: { main: "Grits + Sausage Patty",              protein: "Sausage",        ingredients: ["Grits","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                    sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.52", cal: 640 },
        lunch:     { main: "PB&J",              protein: "Peanut Butter",  ingredients: ["Peanut Butter","Jelly","Bread","Pinto Beans","Peas & Carrots","Cake Mix"],                      sides: ["Pinto Beans","Peas & Carrots","Cake"],       cost: "$0.44", cal: 830 },
      ...
      { day: "Tuesday",
        breakfast: { main: "Oatmeal + 2 Boiled Eggs",            protein: "Eggs",           ingredients: ["Oatmeal","Eggs","Bread","Jelly Packets","Drink Mix"],                                           sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.48", cal: 620 },
        lunch:     { main: "Bologna on Bread",            protein: "Bologna",        ingredients: ["Bologna","Bread","Pasta","Green Beans","Cake Mix"],                                           sides: ["Pasta Salad","Green Beans","Cake"],           cost: "$0.44", cal: 800 },
      ...
      { day: "Wednesday",
        breakfast: { main: "Eggs Scrambled + Sausage",           protein: "Eggs & Sausage", ingredients: ["Eggs","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                  sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.55", cal: 710 },
        lunch:     { main: "PB&J",              protein: "Peanut Butter",  ingredients: ["Peanut Butter","Jelly","Bread","Instant Mashed Potatoes","Corn","Cake Mix"],                   sides: ["Mashed Potatoes","Corn","Cake"],              cost: "$0.42", cal: 800 },
      ...
      { day: "Thursday",
        breakfast: { main: "Grits + 2 Boiled Eggs",              protein: "Eggs",           ingredients: ["Grits","Eggs","Bread","Jelly Packets","Drink Mix"],                                            sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.45", cal: 600 },
        lunch:     { main: "Salami on Bread",             protein: "Salami",         ingredients: ["Salami","Bread","Northern Beans","Carrots","Cake Mix"],                                       sides: ["Northern Beans","Carrots","Cake"],            cost: "$0.46", cal: 800 },
      ...
      { day: "Friday",
        breakfast: { main: "Grits + Sausage Patty",              protein: "Sausage",        ingredients: ["Grits","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.52", cal: 640 },
        lunch:     { main: "Salami on Bread",             protein: "Salami",         ingredients: ["Salami","Bread","Pinto Beans","Mixed Vegetables","Cake Mix"],                                sides: ["Pinto Beans","Mixed Veg","Cake"],             cost: "$0.48", cal: 820 },
      ...
      { day: "Saturday",
        breakfast: { main: "Oatmeal + 2 Boiled Eggs",            protein: "Eggs",           ingredients: ["Oatmeal","Eggs","Bread","Jelly Packets","Drink Mix"],                                         sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.48", cal: 620 },
        lunch:     { main: "Turkey on Bread",             protein: "Turkey",         ingredients: ["Turkey","Bread","Pasta","Peas & Carrots","Cake Mix"],                                        sides: ["Pasta Salad","Peas & Carrots","Cake"],        cost: "$0.56", cal: 850 },
        dinner:    { main: "Chicken Patty & Brown Gravy",        protein: "Chicken",        ingredients: ["Chicken Patties","Brown Gravy Mix","Cornbread Mix","Rotini Pasta","Cookie Mix"],              sides: ["Cornbread","Pasta Salad","Cookie"],           cost: "$0.65", cal: 1010 } },
      { day: "Sunday",
        breakfast: { main: "Eggs Scrambled + Sausage",           protein: "Eggs & Sausage", ingredients: ["Eggs","Sausage Patties","Bread","Jelly Packets","Drink Mix"],                                sides: ["Bread (2 sl)","Jelly","Drink Mix"],           cost: "$0.55", cal: 710 },
        lunch:     { main: "Bologna on Bread",            protein: "Bologna",        ingredients: ["Bologna","Bread","Instant Mashed Potatoes","Green Beans","Cake Mix"],                        sides: ["Mashed Potatoes","Green Beans","Cake"],       cost: "$0.48", cal: 850 },
        dinner:    { main: "Beef Patty & Brown Gravy",           protein: "Beef",           ingredients: ["Beef Patties","Brown Gravy Mix","Cornbread Mix","Rotini Pasta","Cake Mix"],                  sides: ["Cornbread","Pasta Salad","Cake"],             cost: "$0.66", cal: 1020 } }
    ]
  }
];
